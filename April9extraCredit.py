...
def numbCount():
    wordTyped = input("Enter your word: ")
    characterCount = len(wordTyped)
...
def roller_coaster_age(age, height):
    if age >= 14 and height >= 5.2:
        print("User is able to ride roller coaster 1.")
    elif age >= 14 and height  
