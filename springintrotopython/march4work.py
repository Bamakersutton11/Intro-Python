...
def elevatorFloors():
    elevatorStops = input('What floor?: ')
    if elevatorStops == 'M':
        print('lobby')
    elif elevatorStops == 'B':
        print('basement')
    elif elevatorStops == 'R':
        print('rooftop')
    elif elevatorStops == "1":
        print('gym')
    elif elevatorStops == "2":
        print('restaurant')
    elif elevatorStops == "3":
        print('workspace')
    elif elevatorStops == "4":
