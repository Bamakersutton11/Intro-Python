...
"A while loop is a function that continues to follow instructions as long as as statement is true."
"A for loop is a function that iterates over specific data. The difference is that one is harder to control"
"while the other is "
...
def multiply_numbers(one, two, three):
    print(one * two - three)

multiply_numbers(4,2,3)
...
def guessNumber():
    ...
    while userGuess != correct_numb:
        print("Your answer is incorrect try again.")
        userGuess = int(input('Enter new number: '))
